...
function Movie() {
  ...
  const { data: torrents, isPending: isTorrentLoading } = useQuery({
    queryKey: ["movieTorrents"],
  ...
  return (
    <div className="mx-20 mb-40 bg-white rounded-lg border p-4">
      ...
      <div className="grid grid-cols-5 gap-4 mt-8">
        ...
        <div className="col-span-2 flex flex-col justify-between">
          ...
          <div className="bg-secondary flex rounded-lg items-center">
            ...
            <span className="text-sm mr-2">سال انتشار: {data.Year}</span>
          </div>
          <div className="bg-secondary flex rounded-lg items-center">
            <div className="bg-primary text-white p-2">
              <svg
            ...
            <span className="text-sm mr-2">
              زمان: {data?.Runtime?.split(" ").at(0)} دقیقه
            </span>
          </div>
          <div className="bg-secondary flex rounded-lg items-center">
            <div className="bg-primary text-white p-2">
            ...
            <span className="text-sm mr-2">کارگردان: {data.Director}</span>
          </div>
          <div className="bg-secondary flex rounded-lg items-center">
            <div className="bg-primary text-white p-2">
              <svg
        ...
        <div className="col-span-2 flex flex-col justify-between">
          <div className="bg-secondary flex rounded-lg items-center">
            ...
            <span className="text-sm mr-2">ژانر: {data.Genre}</span>
          </div>
          <div className="bg-secondary flex rounded-lg items-center">
            <div className="bg-primary text-white p-2">
              <svg
            ...
            <span className="text-sm mr-2">
              امتیاز منتقدین: 100/{data.Metascore}
            </span>
          </div>
          <div className="bg-secondary flex rounded-lg items-center">
            <div className="bg-primary text-white p-2">
            ...
            <span className="text-sm mr-2">محصول کشور: {data.Country}</span>
          </div>
          <div className="bg-secondary flex rounded-lg items-center">
            <div className="bg-primary text-white p-2">
              <svg
            ...
            <span className="text-sm mr-2">زبان: {data.Language}</span>
          </div>
          <div className="bg-secondary flex rounded-lg items-center">
            <div className="bg-primary text-white p-2">
              <svg
            ...
            <span className="text-sm mr-2">میزان فروش: {data.BoxOffice}</span>
          </div>
          <div className="bg-secondary flex rounded-lg items-center">
            <div className="bg-primary text-white p-2">
              <svg
            ...
            <span className="text-sm mr-2">رده سنی: {data.Rated}</span>
          </div>
        </div>
      </div>
      <div className="bg-secondary flex rounded-lg items-center mt-4">
        ...
        <span className="text-sm mr-2">بازیگران: {data.Actors}</span>
      </div>
      <div className="mt-4">
        {torrents.map((link) => (
          <MovieLink
